...
export function getConsonantCounts(hanzis: Hanzi_org[]) {
...
export function getToneCounts(hanzis: Hanzi_org[]) {
...
export function filterPinyin(hanzi: Hanzi_org, filter: PinyinFilter) {
...
export function buildFormUniqHanzis(hanzis: Hanzi_org[]) {
  return hanzis
    .map((i) => i.form)
...
export const getDifferentTones = (db: Hanzi_org[], hanzi: Hanzi_org) => {
  return db
    .filter(
      (item) =>
    ...
    .reduce(
      ...
      {} as { [key: string]: Hanzi_org[] }
    );
};

export const getDifferentConsonants = (db: Hanzi_org[], hanzi: Hanzi_org) => {
